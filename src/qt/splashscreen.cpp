    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBatlnext    = QChar(0xA9)+QString(" %1-%2 ").arg(2016).arg(COPYRIGHT_YEAR) + QString("The BattlestarCoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextBatlnext);
    }
