...
const char* BIP71_MIMETYPE_PAYMENT = "application/battlestarcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/battlestarcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/battlestarcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click battlestarcoin: links
...
//
// OSX-specific way of handling battlestarcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in battlestarcoin: URIs
